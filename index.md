...
<p class="message">
<strong>I'm currently mentoring approximately 11 students learning Ruby on Rails at <a href="https://codethedream.org">Code The Dream.</a></strong><br>This not-for-profit organization focuses on teaching tech skills to people from diverse backgrounds of which could be underrepresented, historically exluded, and or folks from immigrant backgrounds - all for free! It's a great mission and is a mission that is close to my heart. <br>Check them out!<br><br>
